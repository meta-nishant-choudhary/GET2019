package com.metacube.springmvcjdbc.controller;
...
import com.metacube.springmvcjdbc.fascade.EmployeeFascade;
import com.metacube.springmvcjdbc.fascade.VehicleFascade;
...
public class EmployeeController {
	...
	public void profilepicture(HttpServletRequest request,Model model){
		...
		if(session.getAttribute("email")!=null){
			File file = new File("C:\\Users\\Nishant\\Desktop\\springmvcjdbc\\src\\main\\webapp\\images\\"+session.getAttribute("emp_id").toString()+".jpg");
			if(file.exists()){
