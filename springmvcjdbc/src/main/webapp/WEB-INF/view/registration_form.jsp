...
<body>
	<center>
		<pre>
			...
			Password	    :	<mvc:input path="password" type ="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="password" oninvalid="this.setCustomValidity('Password should contain upper & lower case and numberic and symbol')" oninput="this.setCustomValidity('')" required="required"/>
